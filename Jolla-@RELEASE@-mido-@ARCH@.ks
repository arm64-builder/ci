# DisplayName: Jolla vince/@ARCH@ (release) 0.5.8+master.20241104134713.c99020b
...
repo --name=adaptation-common-vince-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-vince-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
